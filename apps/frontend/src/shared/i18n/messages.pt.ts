export const messages = {
  ...
  'product.list_title': 'Gestão de Produtos',
  ...
  'product.delete_title': 'Excluir Produto',
  'product.delete_description': 'Tem certeza que deseja excluir este produto? Esta ação não pode ser desfeita.',
  'product.name_label': 'Nome',
  'product.name_placeholder': 'Nome do produto',
  'product.description_label': 'Descrição',
  'product.description_placeholder': 'Descrição do produto',
  'product.price_label': 'Preço',
  'product.price_placeholder': '0,00',
  'product.price_invalid': 'O preço deve ser um número válido e não negativo',
  'product.status_label': 'Status',
  'product.status.active': 'Ativo',
  'product.status.inactive': 'Inativo',
  'product.status.draft': 'Rascunho',
  'product.actions': 'Ações',
  'product.basic_data': 'Dados Básicos',
  'product.price_status_section': 'Preço e Status',
  'product.availability_section': 'Disponibilidade',
  'product.available_online_label': 'Disponível Online',
  'product.featured_label': 'Destaque',
  'product.allows_pre_order_label': 'Permite Pré-venda',
  'product.save': 'Salvar',
